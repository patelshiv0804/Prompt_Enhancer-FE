  ...
  return (
    <button
      ...
      style={{
        ...
        background: enabled ? 'linear-gradient(135deg, #7C3AED 0%, #A855F7 100%)' : (isDark ? 'rgba(255, 255, 255, 0.12)' : 'rgba(124,58,237,0.12)'),
...
function ProfileCard({ profile, onToggle, onEdit, onDelete }: {
  ...
  return (
    <div style={{
      ...
      border: `1px solid ${profile.enabled ? (isDark ? 'rgba(167, 139, 250, 0.35)' : 'rgba(124,58,237,0.18)') : (isDark ? 'rgba(255, 255, 255, 0.08)' : 'rgba(124,58,237,0.10)')}`,
      borderRadius: 16,
      padding: '24px',
      ...
      height: '100%',
      minHeight: 280,
      boxShadow: isDark ? '0 4px 20px rgba(0,0,0,0.35)' : 'none',
      ...
      className={isDark ? 'hover:translate-y-[-3px] hover:shadow-[0_8px_24px_rgba(0,0,0,0.6)] hover:!border-[rgba(167,139,250,0.4)] hover:!opacity-100' : 'hover:translate-y-[-3px] hover:shadow-[0_8px_24px_rgba(109,40,217,0.09),0_2px_6px_rgba(0,0,0,0.05)] hover:!border-[rgba(124,58,237,0.18)] hover:!opacity-100'}
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14, flex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <p style={{ margin: 0, fontSize: 15, fontWeight: 600, color: isDark ? D.textPrimary : 'var(--color-text-primary)', lineHeight: 1.3 }}>
              {profile.name}
            </p>
          ...
          <button
            ...
            style={{
              ...
              color: isDark ? D.textMuted : 'var(--color-text-secondary)', transition: 'all 200ms ease', flexShrink: 0,
            }}
            className="hover:!bg-[rgba(239,68,68,0.12)] hover:!text-[#EF4444]"
          >
        ...
        {/* Description */}
        <p style={{
          margin: 0, fontSize: 13, lineHeight: 1.55, color: isDark ? D.textSecondary : 'var(--color-text-secondary)',
      ...
      <div style={{
        borderTop: `1px solid ${isDark ? 'rgba(255, 255, 255, 0.08)' : 'rgba(124,58,237,0.08)'}`,
        paddingTop: 14,
        marginTop: 4,
        display: 'flex',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{
            fontSize: 13.5,
            fontWeight: 600,
            color: isDark ? D.textPrimary : '#312E81',
            display: 'flex',
            alignItems: 'center',
            gap: 2,
          }}>
            Active Style <span style={{ color: isDark ? '#C084FC' : 'var(--color-primary)', fontSize: 12 }}>✦</span>
          </span>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <span style={{ fontSize: 12, color: isDark ? D.textMuted : 'var(--color-text-secondary)', opacity: 0.8 }}>
...
function AddNewCard({ onClick }: { onClick: () => void }) {
  ...
  return (
    <button
      onClick={onClick}
      style={{
        background: isDark ? 'rgba(20, 19, 32, 0.4)' : 'transparent',
        border: `2px dashed ${isDark ? 'rgba(255, 255, 255, 0.12)' : 'rgba(124,58,237,0.18)'}`,
        borderRadius: 16,
        padding: '24px',
      ...
      className={isDark ? 'hover:!border-[rgba(167,139,250,0.4)] hover:!bg-[rgba(255,255,255,0.04)] hover:translate-y-[-2px]' : 'hover:!border-[rgba(124,58,237,0.35)] hover:!bg-[rgba(124,58,237,0.03)] hover:translate-y-[-2px]'}
    >
      <div style={{
      ...
      <span style={{ fontSize: 14, fontWeight: 600, color: isDark ? D.textPrimary : 'var(--color-text-primary)' }}>
        Add New Profile
      </span>
      <span style={{ fontSize: 12, color: isDark ? D.textSecondary : 'var(--color-text-secondary)', textAlign: 'center', maxWidth: 180 }}>
                ...
                <React.Fragment key={step.label}>
                  <div style={{
                    ...
                    <div style={{ textAlign: 'center', width: '100%' }}>
                      <span style={{
                        display: 'block', fontSize: isMobile ? 12 : 14, fontWeight: 700,
                      ...
                      <span style={{
                        display: 'block', fontSize: isMobile ? 10.5 : 12,
                        color: isActive ? step.color : 'rgba(255,255,255,0.40)',
                  ...
                  {i < steps.length - 1 && (
                    compact ? (
                      <div style={{
                        flex: '1 1 0', minWidth: 16, height: 16, position: 'relative',
                        marginTop: nodeSize / 2 - 8,
                      }}>
                        <div style={{
  ...
  return (
    <>
      ...
      <div style={{
        ...
        boxShadow: isDark ? '0 24px 64px rgba(0,0,0,0.8), 0 0 1px rgba(167,139,250,0.4)' : '0 24px 64px rgba(109,40,217,0.18), 0 0 1px rgba(124,58,237,0.3)',
        zIndex: 999,
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{
              ...
              background: isDark ? 'rgba(139, 92, 246, 0.18)' : 'linear-gradient(135deg, rgba(124,58,237,0.1) 0%, rgba(168,85,247,0.1) 100%)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              color: isDark ? '#C084FC' : 'var(--color-primary)',
            }}>
            ...
            <div>
              <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: isDark ? D.textPrimary : 'var(--color-text-primary)', lineHeight: 1.2 }}>
                {isEditing ? 'Edit Style Profile' : 'New Style Profile'}
              </h2>
              <p style={{ margin: 3, padding: 0, fontSize: 12, color: isDark ? D.textSecondary : 'var(--color-text-secondary)' }}>
          ...
          <button
            ...
            style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              color: isDark ? D.textSecondary : 'var(--color-text-secondary)', transition: 'all 200ms ease',
            }}
            className={isDark ? 'hover:!bg-[rgba(255,255,255,0.12)] hover:!text-[#FFFFFF]' : 'hover:!bg-[rgba(124,58,237,0.08)] hover:!text-[var(--color-text-primary)]'}
          >
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: isMobile ? '20px 18px' : '24px 28px', display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <label style={{ fontSize: 12, fontWeight: 600, color: isDark ? D.textPrimary : 'var(--color-text-primary)', letterSpacing: '0.02em' }}>
              Profile Name
            </label>
            <input
              ...
              style={{
                ...
                outline: 'none', color: isDark ? D.textPrimary : 'var(--color-text-primary)',
                transition: 'border-color 200ms ease, box-shadow 200ms ease',
              }}
              className={isDark ? 'focus:!border-[rgba(167,139,250,0.5)] focus:shadow-[0_0_0_3px_rgba(139,92,246,0.15)]' : 'focus:!border-[rgba(124,58,237,0.35)] focus:shadow-[0_0_0_3px_rgba(124,58,237,0.08)]'}
            />
          </div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: isSel ? `2px solid ${meta.color}` : `1px solid ${isDark ? 'rgba(255, 255, 255, 0.08)' : 'rgba(124,58,237,0.12)'}`,
                      background: isSel ? `${meta.color}18` : (isDark ? 'rgba(255, 255, 255, 0.04)' : '#FFFFFF'),
                      cursor: submitting ? 'not-allowed' : 'pointer', textAlign: 'left',
                      transition: 'all 200ms ease',
                    }}
                    className={!isSel ? (isDark ? 'hover:!border-[rgba(255,255,255,0.16)] hover:!bg-[rgba(255,255,255,0.06)]' : 'hover:!border-[rgba(124,58,237,0.22)] hover:!bg-[rgba(124,58,237,0.02)]') : ''}
                  >
                    <div style={{
                    ...
                    <span style={{
                      fontSize: 13,
                      fontWeight: 600,
                      color: isSel ? (isDark ? D.textPrimary : 'var(--color-text-primary)') : (isDark ? D.textSecondary : 'var(--color-text-secondary)'),
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            ...
            <textarea
              ...
              style={{
                ...
                border: `1px solid ${isDark ? 'rgba(255, 255, 255, 0.12)' : 'rgba(124,58,237,0.12)'}`,
                background: isDark ? 'rgba(14, 13, 20, 0.85)' : '#FFFFFF',
                outline: 'none', color: isDark ? D.textPrimary : 'var(--color-text-primary)', resize: 'none',
                lineHeight: 1.55, fontFamily: 'inherit',
                transition: 'border-color 200ms ease, box-shadow 200ms ease',
              }}
              className={isDark ? 'focus:!border-[rgba(167,139,250,0.5)] focus:shadow-[0_0_0_3px_rgba(139,92,246,0.15)]' : 'focus:!border-[rgba(124,58,237,0.35)] focus:shadow-[0_0_0_3px_rgba(124,58,237,0.08)]'}
            />
            <span style={{ fontSize: 11.5, color: isDark ? D.textMuted : 'var(--color-text-secondary)', lineHeight: 1.4 }}>
        ...
        <div style={{
          ...
          borderTop: `1px solid ${isDark ? 'rgba(255, 255, 255, 0.08)' : 'rgba(124,58,237,0.08)'}`,
          background: isDark ? 'rgba(14, 13, 20, 0.95)' : '#FAFAFC',
        }}>
          <button
            onClick={onClose}
            disabled={submitting}
            style={{
              ...
              border: `1px solid ${isDark ? 'rgba(255, 255, 255, 0.12)' : 'rgba(124,58,237,0.12)'}`, cursor: 'pointer',
              background: isDark ? 'rgba(255, 255, 255, 0.06)' : '#FFFFFF',
              color: isDark ? D.textPrimary : 'var(--color-text-primary)',
              transition: 'all 200ms ease',
            }}
            className={isDark ? 'hover:!bg-[rgba(255,255,255,0.10)] hover:!border-[rgba(255,255,255,0.2)]' : 'hover:!bg-[rgba(124,58,237,0.05)] hover:!border-[rgba(124,58,237,0.22)]'}
          >
            Cancel
          </button>
          <button
      ...
      <div id="style-memory-page" style={{
        ...
        <div style={{ padding: isMobile ? '52px 0 22px' : '28px 0 24px' }}>
          ...
          <div style={{
            ...
            <div>
              <h1 style={{ fontSize: 22, fontWeight: 700, color: isDark ? D.textPrimary : 'var(--color-text-primary)', letterSpacing: -0.3, margin: '0 0 6px' }}>
                Style Memory
              </h1>
          ...
          {CATEGORIES.map(cat => (
            <button
              ...
              style={{
                ...
                color: activeFilter === cat.id ? 'white' : (isDark ? D.textSecondary : 'var(--color-text-secondary)'),
                boxShadow: activeFilter === cat.id ? '0 3px 10px rgba(124,58,237,0.25)' : 'none',
              }}
              className={activeFilter !== cat.id ? (isDark ? 'hover:!bg-[rgba(255,255,255,0.10)] hover:!text-[#FFFFFF]' : 'hover:!bg-[rgba(124,58,237,0.12)] hover:!text-[var(--color-text-primary)]') : ''}
            >
              {cat.label}
            </button>
          ))}
        ...
        {loading && profiles.length === 0 ? (
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '60px 0', gap: 10, color: isDark ? D.textSecondary : 'var(--color-text-secondary)' }}>
