...
function SettingsContent({ initialTab = 'settings' }: SettingsPageProps) {
  ...
  const [plan, setPlan] = useState<'Free' | 'Pro' | 'Team' | 'Enterprise'>('Pro');
  const [onboardingComplete, setOnboardingComplete] = useState<boolean>(false);
  const [createdAt] = useState<string>('July 2026');
  const [updatedAt, setUpdatedAt] = useState<string>('July 16, 2026');
  ...
  const onboardingTasks = [
    { id: 't1', label: 'Configure your profile display name', done: displayName !== '' },
    { id: 't2', label: 'Choose a primary AI model signature', done: true },
              ...
              <div style={{
                ...
                {(['light', 'dark', 'system'] as const).map(t => {
                  ...
                  return (
                    <button
                      key={t}
                      onClick={() => { setTheme(t); triggerSavedFeedback('theme'); }}
                      style={{
              ...
              <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                {['ChatGPT', 'Claude', 'Gemini', 'Grok', 'Midjourney', 'VEO', 'Perplexity'].map(modelOpt => {
                  ...
                  return (
                    <button
                      key={modelOpt}
                      onClick={() => { setDefaultModel(modelOpt); triggerSavedFeedback('default_model'); }}
                      style={{
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <ToggleSwitch 
                  ...
                  onToggle={() => {
                    setShowDiffByDefault(!showDiffByDefault);
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <ToggleSwitch 
                  ...
                  onToggle={() => {
                    setAutoDetectIntent(!autoDetectIntent);
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: colors.textPrimary }}>Edit Profile Profile</span>
              <button 
                onClick={() => setIsEditModalOpen(false)} 
                style={{ 
