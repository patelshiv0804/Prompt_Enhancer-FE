      ...
      >
        ...
        <div className="mb-2 sm:mb-3.5 flex items-center justify-between">
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.12em] text-gray-400" style={{ color: isDark ? D.textMuted : undefined }}>
              Raw Prompt
            </span>
          </div>
        ...
        <div className="flex items-center justify-between pt-0.5 sm:pt-1">
          <span className="font-mono text-[10px] sm:text-[11px] lg:text-[12px] text-gray-300 font-medium" style={{ color: isDark ? D.textMuted : undefined }}>
            {value.length.toLocaleString()}
            <span className="text-gray-300" style={{ color: isDark ? D.textMuted : undefined }}>/12,000</span>
          </span>
          <button
            onClick={onSubmit}
            ...
            style={{
              background: isDark ? D.ctaBg : undefined,
              color: isDark ? D.ctaText : undefined,
              borderColor: isDark ? "transparent" : undefined,
              boxShadow: isDark ? D.ctaShadow : undefined,
            }}
            id="improve-btn"
          >
            {isEnhancing ? (
              <>
                <span className="text-gray-200" style={{ color: isDark ? D.ctaText : undefined }}>Enhancing</span>
